"cf_01_ab_bu06_01"
{
	/*
		...
		descr=Warlock are powerful meele units with Chaos Attack and No Armor. Their Special Attack launches a AoE Burst on the Target to deal additional Damage.
	*/
	...
	"cf_ab_spawner"					"1"
	"cf_unit_name"					"cf_01_cr_06_warlock"
	"cf_unit_count"					"1"
	"cf_autocast"					"1"
